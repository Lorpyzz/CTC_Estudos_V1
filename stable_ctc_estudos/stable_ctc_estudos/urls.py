...
urlpatterns = [
    ...
    path('disciplina/<str:nome>/conteudo/adicionar/', views.adicionar_conteudo, name='adicionar_conteudo'),
    path('disciplina/<int:id>/deletar/', views.delete_disciplina, name='delete_disciplina'),
